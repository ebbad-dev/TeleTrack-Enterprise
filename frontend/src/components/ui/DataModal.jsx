...
export function DataModal({ isOpen, onClose, onSave, title, fields, initialData, isSaving, children }) {
        ...
        <div className="fixed inset-0 z-[100] flex items-center justify-center p-4 sm:p-6">
          ...
          >
            <Card className="border-primary/50 shadow-[0_0_30px_rgba(0,240,255,0.15)] p-0 overflow-hidden">
              ...
              {/* If children are provided, render them directly (for custom modal content) */}
              {children ? (
